...
# copied from PHOSA repo:  https://github.com/facebookresearch/phosa/blob/main/phosa/utils/bbox.py
import numpy as np
import torch
...
def make_bbox_square(bbox, bbox_expansion=0.0):
    ...
    Returns:
        Squared bbox (same shape as bbox). width is the max of h and w, xywh format
    """
    bbox = np.array(bbox)
